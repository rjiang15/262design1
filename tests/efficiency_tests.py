...
parser = argparse.ArgumentParser(description="Run efficiency tests for either custom or JSON protocol.")
...
# Global counters for bytes (client side)
total_bytes_sent = 0
total_bytes_received = 0

# For custom protocol, we prepend the version number.
